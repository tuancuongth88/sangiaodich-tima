(function(root, factory) {
  ...
  var pxDemo = (function() {
    ...
    var BACKGROUNDS = [
      'frontend/demo/bgs/1.jpg',
      'frontend/demo/bgs/2.jpg',
      'frontend/demo/bgs/3.jpg',
      'frontend/demo/bgs/4.jpg',
      'frontend/demo/bgs/5.jpg',
      'frontend/demo/bgs/6.jpg',
      'frontend/demo/bgs/7.jpg',
      'frontend/demo/bgs/8.jpg',
      'frontend/demo/bgs/9.jpg',
    ];
    ...
    function setTheme(themeName) {
      ...
      var themePath = 'frontend/css/themes/' + themeName + (_isRtl ? '.rtl' : '') + '.min.css';

      var linksToLoad = [];

      // Switch between light and dark frontend
    ...
    function initializeDemoSidebar(container, skipFooter) {
      ...
      for (var i = 0, l = THEMES.length; i < l; i++) {
        content += '<label class="px-demo-themes-item">';
          ...
          content += '<img src="frontend/demo/themes/' + THEMES[i] + '.png" class="px-demo-themes-thumbnail">';
