            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        {{ Form::open(array('route' => array('service.update', 'id' => $data['id']), 'method' => 'PUT', 'class' => 'm-form m-form--fit m-form--label-align-right', 'enctype' => 'multipart/form-data')) }}
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group col-md-6">
                                ...
                                <img src="http://tima.vn/Template1/images/product/11.png">
                            </div>
                        </div>
