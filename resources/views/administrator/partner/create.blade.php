            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="m-portlet m-portlet--tab">
                        ...
                        {{ Form::open(array('route' => 'partner.store', 'class' => 'm-form m-form--fit m-form--label-align-right', 'enctype' => 'multipart/form-data')) }}
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" class="form-control m-input" id="name" placeholder="Tên đối tác" name="name">
                            </div>
                            <div class="form-group m-form__group">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <textarea class="summernote" id="summernote" name="detail"></textarea>
                            </div>
                        </div>
