        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    {{ Form::open(['route' => isset($data->id) ? ['pages.update', $data->id] : 'pages.store', 'method' => isset($data->id) ? 'PUT' : 'POST', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed', 'files' => true ]) }}
                        @csrf
