        ...
        <div class="m-content">
            <div class="row">
                <div class="col-md-12" style="margin-bottom: 20px">
                    <a href="{{ action('Administrators\Faqs\FaqController@index') }}" class="btn btn-success">Danh
                        sách</a>
                </div>
                <div class="col-md-12">
                    <!--begin::Portlet-->
                    <div class="m-portlet m-portlet--tab">
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <input type="text" class="form-control m-input" id="question" placeholder="Tiêu đề tin"
                            ...
                            <div class="form-group m-form__group">
                                ...
                                <textarea class="summernote" id="summernote" name="answer">
                                    {{ $data['answer'] }}
                                </textarea>
                            </div>
                            <div class="form-group m-form__group">
