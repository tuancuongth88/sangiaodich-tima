    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div class="m-content">
            ...
            <div class="col-xs-12" style="margin-bottom: 20px">
                <a href="{{ action('Administrators\Faqs\FaqController@create') }}"
                    ...
                    <table class="table m-table m-table--head-bg-success">
                        ...
                        @foreach($data as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ action('Administrators\Faqs\FaqController@edit', $value->id) }}"
                                       class="btn btn-accent m-btn m-btn--icon m-btn--icon-only">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    {{ Form::open(array('method'=>'DELETE',
                                    'action' => array('Administrators\Faqs\FaqController@destroy', $value->id),
