        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('route' => 'upload.tax.do_personal', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed m-form--state', 'id' => 'create-news', 'enctype' => 'multipart/form-data')) }}
