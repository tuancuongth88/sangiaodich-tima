...
@section('content')
    ...
    <div class="container py-5">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#doanhnghiep">Doanh nghiệp</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#canhan">Cá nhân</a>
            </li>

        </ul>
        <div class="tm-about bg-white py-5 py-md-5 py-xl-6 px-xl-0">
            <div id="tabsJustifiedContent" class="tab-content">
                <div id="doanhnghiep" class="container tab-pane {{ isActiveRoute('data.tax') }}"><br>
                ...
                <div id="canhan" class="container tab-pane fade {{ isActiveRoute('data.canhan') }}">
                    <div class="px-3 px-md-5 px-xl-8 w-lg-75 mx-auto">
