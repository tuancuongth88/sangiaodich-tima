    ...
    <div class="collapse navbar-collapse" id="px-demo-navbar-collapse">
        ...
        <ul class="nav navbar-nav navbar-right">
                ...
                <div class="dropdown-menu p-a-0" style="width: 300px;">
                    <div id="navbar-messages" style="height: 280px; position: relative;">
                        <div class="widget-messages-alt-item">
                            <img src="frontend/demo/avatars/2.jpg" alt="" class="widget-messages-alt-avatar">
                        ...
                        <div class="widget-messages-alt-item">
                            <img src="frontend/demo/avatars/3.jpg" alt="" class="widget-messages-alt-avatar">
                        ...
                        <div class="widget-messages-alt-item">
                            <img src="frontend/demo/avatars/4.jpg" alt="" class="widget-messages-alt-avatar">
                        ...
                        <div class="widget-messages-alt-item">
                            <img src="frontend/demo/avatars/5.jpg" alt="" class="widget-messages-alt-avatar">
                            <a href="#" class="widget-messages-alt-subject text-truncate">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</a>
            ...
            <li class="dropdown">
                ...
                <img src="frontend/demo/avatars/1.jpg" alt="" class="px-navbar-image">
