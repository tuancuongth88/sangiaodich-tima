                                ...
                                <div class="fs-13" id="divFormRegister">
                                    {{ Form::open(['action' => 'Frontends\Users\UsersController@postRegisterForm', 'method' => 'POST', 'autocomplete' => "off"]) }}
                                        ...
                                        <div class="px-5 py-3">
                                            ...
                                            <div class="form-group">
                                                <select class="selectpicker form-control input-lg" id="cbCity" name="city" placeholder="Chọn thành phố..." required>
                                            ...
                                            <div class="form-group">
                                                <select class="selectpicker form-control input-lg" id="cbDistrict" name="district" data-live-search="true" disabled="" required>
